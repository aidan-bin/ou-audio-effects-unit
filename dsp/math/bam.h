...
#define BAM_MAX_ANGLE \
    ((bam_t) - 1) // Max angle that can be represented in BAM before wrapping back to 0
#define UBAM_MAX_ANGLE \
    ((ubam_t) - 1) // Max angle that can be represented in BAM before wrapping back to 0
