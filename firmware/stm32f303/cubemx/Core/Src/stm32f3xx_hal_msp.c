...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = POT_D_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(POT_D_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = POT_A_Pin|POT_B_Pin|POT_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(POT_D_GPIO_Port, POT_D_Pin);

    HAL_GPIO_DeInit(GPIOA, POT_A_Pin|POT_B_Pin|POT_C_Pin);
